...
func testIndex(c *http.Client, t *testing.T) {
	...
	file, err := os.Open("/config/CloudComputingLabs/Lab2/static/index.html")
	if err != nil {
...
func test404(c *http.Client, t *testing.T) {
	...
	file, err := os.Open("/config/CloudComputingLabs/Lab2/static/404.html")
	if err != nil {
...
func testWrongMethod(c *http.Client, t *testing.T) {
	...
	file, err := os.Open("/config/CloudComputingLabs/Lab2/static/501.html")
	if err != nil {
